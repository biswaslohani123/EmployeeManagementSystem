  ...
  return (
    ...
    <div className='animate-fade-in'>
      ...
      <div className='flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8'>
        ...
        {!isAdmin && !isDeleted && (
          <button onClick={() => setShowModel(true)} className='btn-primary cursor-pointer flex items-center gap-2 w-full sm:w-auto justify-center'>
      ...
      <ApplyLeaveModel open={showModel} onClose={() => setShowModel(false)} onSuccess={fetchLeave}/>
