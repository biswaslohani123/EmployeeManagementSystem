    ...
    <div className='animate-fade-in'>
      ...
      <div className='flex flex-col sm:flex-row gap-3 mb-6'>
        <div className='relative flex-1'>
            ...
            <input onChange={(e) => setSearch(e.target.value) } type="text" placeholder='Search employees....' className='w-full pl-10' value={search} />
        </div>
...

      {
        loading ? (
          ...
          <div className='flex justify-center p-12'>
            ...
            <div className='animate-spin hp-8 w-8 border-2 border-indigo-600 border-t-transparent rounded-full'/>
