    ...
    <div className='fixed inset-0 bg-black/40 backdrop-blur-sm flex items-center justify-center z-50 p-4'>
        ...
        <div   className='card max-w-lg w-full p-6 animate-slide-up'>
            <div className='flex justify-between items-center mb-6'>
                <h3 className='text-lg font-bold text-slate-900 cursor-pointer'>Generate Monthly Payslip</h3>
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                    ...
                    {/* Basic Salary */}
                     ...
                     <div>
                            ...
                            <input type="number" required name='basicSalary' placeholder='5000' />
                    ...
                    <div className='grid grid-cols-2 gap-4'>
                        ...
                        <div>
                            ...
                            <input type="number" name='allowances' required defaultValue="o" />
                        </div>
                        <div>
                            <label  className='block text-sm font-medium text-slate-700 mb-2'>Deductions</label>
                            <input type="number" name='deductions' required defaultValue="o" />
                        </div>
                    ...
                    <div className='flex justify-end gap-3 pt-2'>
                        ...
                        <button  type='submit' className='btn-primary items-center flex cursor-pointer' disabled={loading}>
                            {
