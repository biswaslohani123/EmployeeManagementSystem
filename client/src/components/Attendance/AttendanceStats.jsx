import { AlertCircleIcon, Calendar1Icon, Clock11Icon } from 'lucide-react';
...
export const AttendanceStats = ({history}) => {
    ...
    const stats = [
        ...
        {label: "Avg. Work Hrs", value: "8.5hrs", icon: Clock11Icon},
    ]
    ...
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8'>
        {
            stats.map((s) => (
                ...
                <div key={s.label} className='card card-hover p-5 sm:p-6 flex items-center gap-4 relative overflow-hidden group'>
                    ...
                    <div>
                        <p className='text-s text-slate-500'>{s.label}</p>
