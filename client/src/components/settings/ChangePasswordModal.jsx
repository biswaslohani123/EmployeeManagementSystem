    ...
    <div onClick={onClose} className='fixed inset-0 z-50 flex items-center justify-center p-4'>
        ...
        <div className='relative bg-white rounded-2xl shadow-2xl w-full max-w-md animate-fade-in' onClick={(e) => e.stopPropagation()}>
            ...
            <div className='flex items-center justify-between p-6 pb-0'>
                <h2 className='text-lg font-medium text-slate-900 flex items-center gap-2' > <Lock className='w-5 h-5 text-slate-400'/> Change Password</h2>
                <button className='p-2 cursor-pointer rounded-lg hover:bg-slate-100 transition-colors text-slate-400 hover:text-slate-600' onClick={onClose}><X className='w-4 h-5'/></button>
            </div>
            ...
            <form  className='p-6 space-y-5 ' onSubmit={handleSubmit}>
                ...
                <div className='flex gap-3 pt-2'>
                    ...
                    <button type='submit' disabled={loading} className='btn-primary flex justify-center gap-2 flex-1'>
