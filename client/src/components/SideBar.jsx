...
import { CalculatorIcon, ChevronRightIcon, DollarSignIcon, FileText, FileTextIcon, icons, LayoutGrid, LogOutIcon, MenuIcon, Settings, User2Icon, XIcon } from 'lucide-react';
...
const SideBar = () => {
    ...
    const sideBarContent = (
        ...
        <>
            ...
            <div className='px-5 pt-6 pb-5 border-b border-white/6'>
                <div className='flex items-center justify-between'>
                    <div className='flex items-center gap-3'>
                        <User2Icon className='text-white size-7'/>
                    <div>
            ...
            <button onClick={handelLogOut} className='flex items-center gap-3 w-full px-3 py-2.5 rounded-md text-[13px] font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8 transition-all duration-150 cursor-pointer'>
  ...
  return (
    ...
    <>
        ...
        text-white shrink-0 border-r border-white/4 bg-linear-to-b from-slate-900 via-slate-900 to-slate-900'>
            {sideBarContent}
        ...
        <aside className={`lg:hidden fixed inser-y-0 left-0 w-72 bg-linear-to-b from-slate-900 via-slate-900 to-slate-950 text-white z-50 flex flex-col transform transition-transform duration-300 ${mobileMenu ? 'translate-x-0' : "-translate-x-full"}`}>
            {sideBarContent}
        </aside>
